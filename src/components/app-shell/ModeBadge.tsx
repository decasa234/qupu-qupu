            ...
            >
              ...
              {showClaire && (
                <button
                  ...
                  className="flex w-full items-center gap-2.5 rounded-[12px] px-3 py-2 text-left font-display text-sm font-black text-qupu-brand-blue transition-colors hover:bg-qupu-shell"
                >
                  <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center text-base">
                    <i className="fa-solid fa-brain" aria-hidden="true" />
                  </span>
                  <span className="flex-1">WMI Claire</span>
                  <i className="fa-solid fa-chevron-right text-[10px] text-qupu-muted/70" aria-hidden="true" />
                </button>
              )}
            </div>
          </div>,
