...
export default function DashboardHero({ vm }: Props) {
  ...
  return (
    <section className="relative overflow-hidden rounded-[2.5rem] border-[3px] border-dashed border-qupu-brand-orange/60 bg-white p-6 shadow-[6px_8px_0_0_#FFD3B1] sm:p-8">
      ...
      <div className="grid gap-6 lg:grid-cols-[auto_1fr] lg:items-center lg:gap-10">
        ...
        <div className="flex justify-center">
          <div className="relative">
            <img
              ...
              draggable={false}
              aria-hidden="true"
              className="pointer-events-none h-32 w-auto select-none drop-shadow-[0_10px_24px_rgba(120,60,0,0.25)] sm:h-36"
            />
        ...
        <div className="min-w-0">
          ...
          <p className="mt-2 text-sm font-medium text-qupu-muted sm:text-base">
            {onFire
              ? 'Konsistensi belajar luar biasa — pertahankan terus!'
              : 'Belajar 5 menit lagi hari ini untuk menjaga streak.'}
          </p>
