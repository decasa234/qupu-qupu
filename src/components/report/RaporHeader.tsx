...
export default function RaporHeader({ childName, ageGroupName, periodStart, periodEnd, avatarColor }: Props) {
  return (
    <header className="flex items-start justify-between gap-4 border-b-[3px] border-qupu-brand-blue pb-3">
      <div>
        <div className="text-[0.625rem] font-extrabold uppercase tracking-[0.18em] text-qupu-brand-orange">
          Rapor Belajar QUPU
        </div>
      ...
      <div className="text-right">
        ...
        />
        <div className="mt-1 text-[0.625rem] font-extrabold text-qupu-muted">QUPU.ID</div>
      </div>
    </header>
  )
}
