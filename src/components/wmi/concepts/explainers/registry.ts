...
const EXPLAINER_LOADERS: Record<string, ExplainerLoader> = {
  ...
  'count-two-digit-numbers': () => import('./CountTwoDigitNumbersExplainer'),
  'calendar-day-reasoning': () => import('./CalendarDayReasoningExplainer'),
  'common-factor-shortcut': () => import('./CommonFactorShortcutExplainer'),
  'consecutive-integer-sum': () => import('./ConsecutiveIntegerSumExplainer'),
  'cryptarithmetic-addition': () => import('./CryptarithmeticAdditionExplainer'),
  'container-capacity-allocation': () => import('./ContainerCapacityAllocationExplainer'),
  'painted-cube-faces-count': () => import('./PaintedCubeFacesCountExplainer'),
  'rank-computed-expressions': () => import('./RankComputedExpressionsExplainer'),
  'solve-symbol-equations': () => import('./SolveSymbolEquationsExplainer'),
  'sort-count-by-attribute': () => import('./SortCountByAttributeExplainer'),
  'count-many-objects': () => import('./CountManyObjectsExplainer'),
  'number-figure-rule': () => import('./NumberFigureRuleExplainer'),
  'length-measure-compare': () => import('./LengthMeasureCompareExplainer'),
  'balance-substitution': () => import('./BalanceSubstitutionExplainer'),
  'sequence-repair': () => import('./SequenceRepairExplainer'),
  'transfer-to-equalize': () => import('./TransferToEqualizeExplainer'),
