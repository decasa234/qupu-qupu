// Number sum-grid figure for WMI-24F3A-Q25 (2024 Grade 3 Final, HARD).
//
// "Fill the numbers 1-9 into the squares so each ROW uses 1-9 exactly once. Each
// CIRCLE below a column group holds the sum of the three squares directly above
// it, and the three numbers stacked vertically in a column are all DIFFERENT.
// The printed circle sums are 15, 17, 14, 18, 13, 16, 9, 16, 17. Find ● + ◆ - ★."
// Answer: 10 (fill-in).
//
...
//   col 1 sum 17:  ● + 2 + 8 = 17  with the column distinct  ->  ● = 7
//   col 3 sum 18:  1 + ◆ + 9 = 18                            ->  ◆ = 8
//   col 7 sum 16:  4 + 7 + ★ = 16                            ->  ★ = 5
// Hence ● + ◆ - ★ = 7 + 8 - 5 = 10.
//
 ...
 * ◆ = 8, ★ = 5. Verified against the printed circle sums: column totals come out
 * 15 17 14 18 13 16 9 16 17 exactly. Used ONLY when the animator passes
 * `solved`; the bare question figure never shows these numbers.
 *
...
export interface NumGrid24G3Props {
  /**
...
/**
 * Bare 3x9 number sum-grid primitive: givens, the ●/◆/★ target markers, and the
 ...
 */
export function NumGrid24G3({ solved = false }: NumGrid24G3Props = {}) {
  return (
...
// never the answer.
const ARIA =
  'Kisi 3 baris dan 9 kolom. Setiap baris diisi bilangan 1 sampai 9 tepat sekali. ' +
...
export default function NumGrid24G3Illustration() {
  return (
...
export { NumGrid24G3Illustration }
