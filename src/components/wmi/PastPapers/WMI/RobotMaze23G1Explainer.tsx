...
import { RobotMaze23G1, OPTIMAL_ROUTE } from './RobotMaze23G1Illustration'
import { buildRobotMaze23G1Steps } from './robotMaze23G1Steps'

// Echo the qupu tokens the static maze already uses so the animation reads as the
// same scene coming alive. The traced route + robot are drawn by the RobotMaze23G1
...
export default function RobotMaze23G1Explainer(props: ExplainerProps) {
  const lang = props.lang ?? 'en'
  const story = useMemo(() => buildRobotMaze23G1Steps(lang), [lang])
  ...
  return (
    <div className="mx-auto w-full max-w-[320px]" role="img" aria-label={ariaLabel}>
      <div className="flex flex-col items-center gap-3">
        ...
        <RobotMaze23G1 route={OPTIMAL_ROUTE} step={beat.step} />
