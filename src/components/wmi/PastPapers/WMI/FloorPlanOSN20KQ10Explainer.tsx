...
import { FloorPlanFigure } from './FloorPlanOSN20KQ10Illustration'
import {
  buildFloorPlanOSN20KQ10Steps,
  ANSWER_EN,
  ANSWER_ID,
} from './floorPlanOSN20KQ10Steps'
...
export default function FloorPlanOSN20KQ10Explainer(props: ExplainerProps) {
  const lang   = props.lang ?? 'id'
  const steps  = useMemo(() => buildFloorPlanOSN20KQ10Steps(lang), [lang])
  ...
  const ariaLabel =
    lang === 'id'
      ? 'Penjelasan: luas lantai 2 = 36 × ¾ = 27 m².'
      : 'Explainer: Floor 2 area = 36 × ¾ = 27 m².'
    ...
    <div className="mx-auto w-full max-w-[400px]" role="img" aria-label={ariaLabel}>
      <div className="flex flex-col items-center gap-3">
        <motion.div
          ...
          className="w-full"
        >
          <FloorPlanFigure phase={beat.phase} lang={lang} />
        </motion.div>
