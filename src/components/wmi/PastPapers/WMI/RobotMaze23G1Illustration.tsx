// WMI-23F1A-Q25 (Grade 1, 2023 Final, Paper A) — robot square maze (fill-in, answer = 20).
//
...
// Walls were read pixel-by-pixel from db/seed/wmi/figures/2023-final-g1-a-q25.jpg
// (each interior cell edge sampled for dark ink — every edge read a clean 0 or 1):
//
...
// the answer (20) is never revealed. The animator imports RobotMaze23G1 and feeds
// `route` + `step` to trace the robot square by square.
//
 ...
 * order of cells entered. Exposed so the animator can default-trace it.
 */
...
/** A gray entry/exit arrow pointing East, centred on row `r`. */
...
/**
 * Reusable primitive (for the animator). Draws the 6x5 square maze, all walls,
 * the entrance + exit gaps with flow arrows, and the robot at the start. Optionally:
 ...
 */
export default function RobotMaze23G1Illustration() {
  return (
    <div
