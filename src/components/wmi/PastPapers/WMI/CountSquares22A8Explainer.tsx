...
import { CountSquares22A8Figure, sizeColor } from './CountSquares22A8Illustration'
import { buildCountSquares22A8Steps } from './countSquares22A8Steps'

const GREEN = '#10B981'

export default function CountSquares22A8Explainer(props: ExplainerProps) {
  const lang = props.lang ?? 'en'
  const story = useMemo(() => buildCountSquares22A8Steps(lang), [lang])
  ...
  return (
    <div className="mx-auto w-full max-w-[320px]" role="img" aria-label={ariaLabel}>
      <div className="flex flex-col items-center gap-3">
        <CountSquares22A8Figure highlightSize={beat.phase === 'count' ? beat.size : null} />
