...
import { CoinTriangle21A7Figure } from './CoinTriangle21A7Illustration'
import { buildCoinTriangle21A7Steps } from './coinTriangle21A7Steps'

// SEAMO-21-A-Q7 — post-answer beat-driven explainer.
//
// Reuses CoinTriangle21A7Figure from the illustration so the animation reads
...
//   5. result  — all coins green; answer A confirmed.

const GREEN = '#10B981'
const BLUE  = '#30598A'
const RED   = '#EF4444'

export default function CoinTriangle21A7Explainer(props: ExplainerProps) {
  const lang = props.lang ?? 'en'

  const story = useMemo(() => buildCoinTriangle21A7Steps(lang), [lang])
  ...
  const ariaLabel =
    lang === 'id'
      ? 'Penjelasan: setiap sisi segitiga punya 6 koin, namun 3 koin sudut dihitung dua kali. Kurangi 3: 18 − 3 = 15 koin. Jawaban A.'
      : 'Explainer: each side of the triangle has 6 coins, but 3 corner coins are counted twice. Subtract 3: 18 − 3 = 15 coins. Answer A.'
