...
import { CountTri20A1Figure } from './CountTri20A1Illustration'
import { buildCountTri20A1Steps } from './countTri20A1Steps'

const GREEN = '#10B981'

export default function CountTri20A1Explainer(props: ExplainerProps) {
  const lang = props.lang ?? 'en'
  const story = useMemo(() => buildCountTri20A1Steps(lang), [lang])
