// HKIMO-22-P2H-Q17 — animated explainer.
//
// Reveals all 7 line segments one-by-one in distinct colours,
// with a running count badge, landing on the answer = 7.
...
import { NODES, EDGES, SVG_W, SVG_H } from './GraphSegmentsHK22P2Q17Illustration'
import { buildGraphSegmentsHK22P2Q17Steps } from './graphSegmentsHK22P2Q17Steps'
import type { Lang } from './graphSegmentsHK22P2Q17Steps'
...
export default function GraphSegmentsHK22P2Q17Explainer({
  lang = 'en',
  step,
  playing,
  onStepCount,
  ...
  const steps = useMemo(
    () => buildGraphSegmentsHK22P2Q17Steps(lang as Lang),
    [lang],
  )
