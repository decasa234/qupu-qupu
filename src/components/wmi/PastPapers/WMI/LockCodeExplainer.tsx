...
import { LockCodeFigure } from './LockCodeIllustration'
import { buildLockCodeSteps } from './lockCodeSteps'

const GREEN = '#10B981'

export default function LockCodeExplainer(props: ExplainerProps) {
  const lang = props.lang ?? 'en'
  const story = useMemo(() => buildLockCodeSteps(lang), [lang])
