...
export default function AppShell() {
  ...
  return (
    // Mobile: the whole shell uses the brighter warm white the desktop phone
    // frame uses (#FFF8F0); on lg+ the page behind the frame stays cream.
    <div className="flex min-h-screen flex-col bg-[#FFF8F0] lg:bg-qupu-cream">
      ...
      {/* Celebration popups (level up / streak / bab baru) — never during a
          play session; the queue greets the kid right after instead. */}
      {!playing && <CelebrationHost />}
