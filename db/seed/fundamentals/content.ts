    ...
    blocks: [
      {
        ...
        type: 'prose',
        body_en:
          'Math has its own special words. If you know what each word means, a hard-looking question becomes simple. These are the words that show up most often in real olympiad papers — tap each card to remember it.',
        body_id:
          'Matematika punya kata-kata khusus. Kalau kamu tahu arti tiap kata, soal yang terlihat sulit jadi mudah. Inilah kata-kata yang paling sering muncul di soal olimpiade sungguhan — ketuk tiap kartu untuk mengingatnya.',
      },
      {
        id: 'b2',
        type: 'glossary',
        term_slugs: ['number', 'digit', 'sum', 'difference', 'even', 'odd'],
        intro_en: 'Number & operation words:',
        intro_id: 'Kata bilangan & operasi:',
      },
      {
        id: 'b3',
        type: 'check',
        prompt_en: 'Which of these is an even number?',
        prompt_id: 'Manakah yang merupakan bilangan genap?',
        choices_en: ['7', '8', '9'],
        choices_id: ['7', '8', '9'],
        answer_index: 1,
        explain_en: 'An even number ends in 0, 2, 4, 6, or 8 — so 8 is even.',
        explain_id: 'Bilangan genap berakhiran 0, 2, 4, 6, atau 8 — jadi 8 genap.',
      },
      {
        id: 'b4',
        type: 'glossary',
        term_slugs: ['square', 'triangle', 'circle', 'side', 'angle', 'perimeter'],
        intro_en: 'Shape words:',
        intro_id: 'Kata bentuk:',
      },
      {
        id: 'b5',
        type: 'check',
      ...
      },
      {
        id: 'b6',
        type: 'glossary',
        term_slugs: ['length', 'weight', 'minute', 'half', 'pair'],
        intro_en: 'Measuring words:',
        intro_id: 'Kata ukuran:',
      },
    ],
  },
  {
