...
-- Brand-agnostic beginner course: ordered modules → lessons of typed
-- content blocks (JSONB, validated by api/services/fundamentals/blocks.ts).
-- Lessons are universal (brand IS NULL); progress is per (child, lesson).
-- ─────────────────────────────────────────────────────────────────────
